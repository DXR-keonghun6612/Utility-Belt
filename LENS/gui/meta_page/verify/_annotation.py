...
from gui.meta_page.verify import _overlay
from gui.meta_page.verify._edit_form import _Ann_edit_form
from gui.meta_page.verify._helpers import _bbox_of, _color_icon
