...
#: class 를 못 정한 객체의 fallback (detection 은 전경만 내고 class 를 모른다).
...
class Detect_instances(Base_Process, outputs=("object",), category="모델/분할"):
    ...
    def Run(self, frame: np.ndarray, class_id: str | None = None, **kwargs) -> dict:
        ...
        _cls = class_id or _UNCLASSIFIED
